...
{
    public class SinisterNatureSpecSingleResult :Specification<SinisterNature>, ISingleResultSpecification
    {

        public SinisterNatureSpecSingleResult(SinisterNatureFilter filter)
        {
