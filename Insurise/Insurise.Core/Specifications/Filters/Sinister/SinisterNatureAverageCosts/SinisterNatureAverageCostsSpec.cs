...
{
    public class SinisterNatureAverageCostsSpec : Specification<SinisterNatureAverageCost>
    {
        public SinisterNatureAverageCostsSpec(SinisterNatureAverageCostsFilter filter)
        {
