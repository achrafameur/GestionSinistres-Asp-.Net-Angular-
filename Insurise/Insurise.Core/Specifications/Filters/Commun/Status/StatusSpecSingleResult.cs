...
{
    public class StatusSpecSingleResult : Specification<Insurise.Core.Entities.Sinister.SinisterAggregate.Status>, ISingleResultSpecification
    {

        public StatusSpecSingleResult(StatusFilter filter)
        {
