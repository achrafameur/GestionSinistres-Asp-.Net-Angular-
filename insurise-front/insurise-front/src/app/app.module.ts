...
import {ApplicationConfigService} from "./main/apps/config/application-config.service";
...
export class AppModule {
  constructor(
    ...
    applicationConfigService.setEndpointPrefix(environment.apiUrl+environment.apiBaseUrl);
  }
