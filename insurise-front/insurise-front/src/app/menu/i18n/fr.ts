  ...
  data: {
    MENU: {
      ...
      SINISTER: {
        ...
        COLORS: 'Couleurs',
        FEATHER: 'Plume',
        AVERAGE_COST:'Cout Moyen ',
        THIRD_COMPANY:'Agence Tiers',
        THIRD_PARTY:'Tiers',
        EXPERT:'Expert',
        STATUS:'Statut',
        SINISTER_NATURE:'Sinister Nature',
        SINISTERDECLARATION:'Déclaration Sinistre',
        SINISTERLIST:'Liste Dossiers Sinistres',
        CARDS: {
          COLLAPSIBLE: 'Cartes',
          BADGE: 'Nouveau',
          BASIC: 'De base',
